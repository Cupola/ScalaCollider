h2. ScalaCollider ==<small>-- version 0.12 (built 17-may-10) --</small>==
...
ScalaOSC currently compiles against Scala 2.8.0.RC2. It requires Java 1.6 and SuperCollider 3.3.1+. It depends on ScalaOSC ( "github.com/Sciss/ScalaOSC":http://github.com/Sciss/ScalaOSC ) and ScalaAudioFile ( "github.com/Sciss/ScalaAudioFile":http://github.com/Sciss/ScalaAudioFile
